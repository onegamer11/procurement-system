...
export const loadFromLocalStorage = () => async (dispatch) => {
    try {
      ...
      dispatch({
        type: 'SITE_MANAGER_LOCAL_STORAGE',
        payload: { siteManagerInfo: siteManagerInfoFromStorage },
      });
      dispatch({
        type: 'SUPPLIER_LOCAL_STORAGE',
        payload: { supplierInfo: supplierInfoFromStorage },
      });
      dispatch({
        type: 'STAFF_LOCAL_STORAGE',
        payload: { staffInfo: staffInfoFromStorage },
      });
    } catch (error) {
...
// 	? JSON.parse(localStorage.getItem("siteManagerInfo"))
// 	: null;
//     console.log("siteManagerInfoFromStorage:", siteManagerInfoFromStorage);
...
// console.log("staffInfoFromStorage:", staffInfoFromStorage);
